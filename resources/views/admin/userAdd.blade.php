    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Add new Client / Back-Office</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.user.save') }}">
                        ...
                        <div class="form-group{{ $errors->has('role_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control m-bot15" autocomplete="off" name="role_id" id="role_id">
                                    <option value="" @if(old('role_id') == '') selected @endif >-Select Role-</option>
                                    <option value="2" @if(old('role_id') == '2') selected @endif >Back-Office</option>
                                    <option value="3" @if(old('role_id') == '3') selected @endif >Client</option>
                                </select>
