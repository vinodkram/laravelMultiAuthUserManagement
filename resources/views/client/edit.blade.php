        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					...
					<form class="form-horizontal" method="POST" action="{{ route('client.update') }}" autocomplete="off">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="date_of_birth" type="text" placeholder="mm/dd/yyyy" class="form-control" name="date_of_birth" required value="{{ (old('date_of_birth'))?old('date_of_birth'):date('m/d/Y',strtotime($client->date_of_birth))}}">
                                @else
                        ...
                        <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="phone_number" type="text" class="form-control" name="phone_number" required value="{{ (old('phone_number'))?old('phone_number'):$client->phone_number}}">
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control" name="address" required value="{{ (old('address'))?old('address'):$client->address}}">
                        ...
                        <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="country" type="text" class="form-control" name="country" required value="{{ (old('country'))?old('country'):$client->country}}">
                        ...
                        <div class="form-group{{ $errors->has('trading_account_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="trading_account_number" type="text" class="form-control" name="trading_account_number" required value="{{ (old('trading_account_number'))?old('trading_account_number'):$client->trading_account_number}}">
                        ...
                        <div class="form-group{{ $errors->has('balance') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="balance" type="text" class="form-control" name="balance" required value="{{ (old('balance'))?old('balance'):$client->balance}}">
                        ...
                        <div class="form-group{{ $errors->has('open_trades') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="open_trades" type="text" class="form-control" name="open_trades" required value="{{ (old('open_trades'))?old('open_trades'):$client->open_trades}}">
                        ...
                        <div class="form-group{{ $errors->has('close_trades') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="close_trades" type="text" class="form-control" name="close_trades" required value="{{ (old('close_trades'))?old('close_trades'):$client->close_trades}}">
